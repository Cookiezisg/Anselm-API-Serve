	...
	return []Spec{
		...
		{Key: "VOICE_ACCOUNT_CEILING", Tier: TierRuntimeHot, Bounded: true, Min: 0, Max: MaxVoiceAccountCeiling,
			apply: func(c *Config, raw string) error {
				...
				if err == nil {
					c.VoiceAccountCeiling = n
				}
				return err
			},
			get: func(c *Config) string { return strconv.FormatInt(c.VoiceAccountCeiling, 10) }},
		...
		{Key: "MEDIA_DOMAIN", Tier: TierStartupHard, RestartRequired: true, get: func(c *Config) string { return c.MediaFetchDomain }},
